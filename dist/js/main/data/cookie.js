$(document).ready(function(){
    ...
    function createPop(opt){  
        ...
        // var opt = Object.assign({}, def_opt, opt); //es6문법이라 ie에서는 동작X 
        ...
        $("body").append(  
            $("<aside>").attr("id", id_name)
                ...
                .append(
                    ...
                    .append(
                        $("<h1>").text("Welcome!"),
                        $("<p>").text("Join our member club today and get updates of new products and special offers"),
                        $("<a href=member.html>").text("Join Us!")
                    ),
                    $("<div class='wrap'>")
                        .append(
                            $("<input type='checkbox'>"),
